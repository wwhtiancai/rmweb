...
function printSqb1()
{
    ...
    if(code=="1")
    {
        ...
        if (zzzm != null && zzzm!="--") 
        {
			...
			if(zzzm.length>3)
			{
				z3=zzzm.substring(3,4);
			}
			if(zzzm.length>4)
			{
				z4=zzzm.substring(4,5);
			}
			if(zzzm.length>5)
			{
				z5=zzzm.substring(5,6);
			}
			if(zzzm.length>6)
			{
				z6=zzzm.substring(6,7);
			}
			if(zzzm.length>7)
			{
				z7=zzzm.substring(7,8);
			}
			if(zzzm.length>8)
			{
				z8=zzzm.substring(8,9);
			}
			if(zzzm.length>9)
			{
				z9=zzzm.substring(9,10);
			}
			if(zzzm.length>10)
			{
				z10=zzzm.substring(10,11);
			}
			if(zzzm.length>11)
			{
				z11=zzzm.substring(11,12);
			}
			if(zzzm.length>12)
			{
				z12=zzzm.substring(12,13);
			}
			if(zzzm.length>13)
			{
				z13=zzzm.substring(13,14);
			}
			if(zzzm.length>14)
			{
				z14=zzzm.substring(14,15);
			}
			if(zzzm.length>15)
			{
				z15=zzzm.substring(15,16);
			}
			if(zzzm.length>16)
			{
				z16=zzzm.substring(16,17);
			}
			if(zzzm.length>17)
			{
				z17=zzzm.substring(17,18);
			}
		}
		var ls_ywyy=xmlDoc.getElementsByTagName("ywyy")[0].firstChild.data;
		var ls_yjszh = xmlDoc.getElementsByTagName("sfzmhm")[0].firstChild.data;
        ...
        {	
			...
			if(gnid=='T')
				cs=cs+"Text,Text606,8.466675,179.3877,黑体,9.75,False,√,-2147483640|"	
			cs=cs+"Text,Text96,8.466675,175.1543,黑体,9.75,False,□延期换证,-2147483640|"
			if(gnid=='S')
				cs=cs+"Text,Text607,8.466675,175.1543,黑体,9.75,False,√,-2147483640|"
				
			cs=cs+"Text,Text94,8.466675,167.2168,黑体,9.75,False,□注销恢复,-2147483640|"
			if(gnid=='N')
				cs=cs+"Text,Text608,8.466675,167.2168,黑体,9.75,False,√,-2147483640|"
				
			cs=cs+"Text,Text92,8.466675,157.1627,黑体,9.75,False,□注销,-2147483640|"
			if(gnid=='G')
				cs=cs+"Text,Text609,8.466675,157.1627,黑体,9.75,False,√,-2147483640|"
...
function printSlpz()
{
    ...
    if(code=="1")
    {
    	...
    	try
    	{
    		...
    		else if(glbm.substring(0,4)=="1310")
    		{
  				cs="Text,Text1,.5291672,-.5291672,宋体,14.25,False,廊坊交通警察支队车管所|";
  				cs=cs+"Text,Text2,11.75835,7.40834,宋体,14.25,False,机动车驾驶证业务受理凭证|";
  				cs=cs+"Text,Text3,17.99168,16.93335,宋体,12,False,业务流水号：|";
  				cs=cs+"Text,lsh,16.93335,25.13544,"+tmzt+",False,*"+lsh+"*|";
  				cs=cs+"Text,Text4,.5291672,43.92088,宋体,10.5,False,业务种类：|";
