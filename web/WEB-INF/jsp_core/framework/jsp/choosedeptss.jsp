...
function tonload(){
	...
	tree.loadXML("department.frm?method=queryBmdmTreeListss&glbm=<%=glbm%>&minbmjb=<%=minbmjb%>&flag=<%=flag%>");
}
function tok(){
...
<table>
	...
	<tr>
		...
		<td align="center">	
			<input type="button" name="qx" value=" 删除 " onclick="tt();">
		</td>
		<td align="left" style="padding-left:5px;">	
			<input type="button" name="qx" value=" 关闭 " onclick="toke();">
		</td>
	<tr>
