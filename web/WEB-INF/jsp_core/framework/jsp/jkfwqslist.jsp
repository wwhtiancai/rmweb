...
<html>
  ...
  function query_cmd()
  {   
      if(document.all.jkxlh.value=="")
      {
          displayInfoHtml("[00R9853J1]:查询条件【外挂系统】不能为空！");
          return;
      }
      //本页刷新
      document.formain.action="<c:url value="/ws.frm?method=queryJkfwqs"/>";
	...
	<body onload="init()"  onUnload="closesubwin();">
		...
		<form name="formain" method="post" action="">
			<table border="0" cellspacing="1" cellpadding="0"
				...
				<tr>
					<td width="70" class="list_headrig">统计时间&nbsp;
					</td>
					...
					<td width="100" class="list_head">
						<select name="jkxlh" style="width: 180" onchange="queryjkid_cmd()">
					...
					<td class="list_body_out" width="150">
					    <select name="jkid" class="text_12" style="width:150">
							<%=jkoptions %>
						</select>
					</td>				
