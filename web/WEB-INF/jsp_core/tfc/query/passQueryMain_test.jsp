...
var passArray = [{"KKBH:11,"KKJC":"test","KKJD":120,"KKWD":30,"GCSJ":"2011-11-20 14:30"},{}];
...
function drawResult(){	    
		kkArray, markerArray = null;
		var startKK, endKK = null;
		var strPaths = null;
	    ...
	    for (var i = 0; i < kkArray.length; i++){
	       ...
	       for (var j = 0; j < passArray.length; j++) {
	          if (passArray[j].KKBH == kkArray[i]){
	            if (!istate){
	            var strPoint = new Point(passArray[j].KKJD,passArray[i].KKWD);
	            var strTitle = passArray[j].KKJC;
	            var uIcon = new Icon(); 
	            uIcon.height = 30;
                uIcon.width = 18;
                uIcon.leftOffset = 0;
                ...
                if(markerArray[i] == startKK)  uIcon.image = _imgSTAT;
                else if (markerArray[i] == endKK) uIcon.image = _imgEND;
                else uIcon.image = _imgMID;
	            }
	            strTitle += "<br>"+(istate+1)+":"+passArray[j].GCSJ;
	            istate++;     
	          }
...
function validCxfw(xzqh){
	// var cxfwAry = $("input[type=checkbox][checked=true]");
}
				...
				<form action="" method="post" name="myform" id="myform">
					...
					<table border="0" cellspacing="1" cellpadding="0" class="query">
						...
						<tr>
							...
							<td class="body" >
								<input type="text" value="浙BVY377"	name="hphm" id="hphm" maxlength="15" style="width:180" onKeyUp="hphmToUp()" onblur="hphmToUpAll()" onFocus="setPos()">
					...
					<tr>
						...
						<td class="head"><span class="gotta">*</span>验证码</td>
		              	<td  class="body"><input name="yzm" id="yzm" type="text"  maxlength="4"  style="width:75;text-transform: uppercase;"  value="" >
		              		<iframe name="ifrmaeecsideveh" width="150" height="30" frameborder="0" src="tfcQuery.tfc?method=getValidImageOpen" allowTransparency="false" scrolling=no></iframe>
		             	 </td>
					</tr>
		            <tr>
