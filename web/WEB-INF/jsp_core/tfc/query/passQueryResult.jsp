...
function getPass(idx){
	...
	$.getJSON(curUrl,function(data){
			...
			if(code == 1){
				...
				//tmpTplj = decodeURIComponent(msg['tplj']);
				//tmpTp1 = decodeURIComponent(msg['tp1']);
				//tmpTp2 = decodeURIComponent(msg['tp2']);
				//tmpTp3 = decodeURIComponent(msg['tp3']);
				...
				imgHtm = '<div class="jqzoomPassQuery" onclick="passPicWid=openImage(\'tp1\')" style="margin:5px;"><img id="tp1" src="' + srcTp1 + '" jqimg="' + srcTp1 + '" width="' + picWidth + 'px" height="' + picHeight + 'px"></div>';
				if(srcTp2 != ''){
					imgHtm += '<div class="jqzoomPassQuery" onclick="passPicWid=openImage(\'tp2\')" style="margin:5px;"><img id="tp2" src="' + srcTp2 + '" jqimg="' + srcTp2 + '" width="' + picWidth + 'px" height="' + picHeight + 'px"></div>';
				}
				if(srcTp3 != ''){
					imgHtm += '<div class="jqzoomPassQuery" onclick="passPicWid=openImage\'tp3\')" style="margin:5px;"><img id="tp3" src="' + srcTp3 + '" jqimg="' + srcTp3 + '" width="' + picWidth + 'px" height="' + picHeight + 'px"></div>';
				}
	...
	<div id="block">
		...
		<table border="0" cellspacing="1" cellpadding="0" class="detail">
			...
			<tr>
				...
				<td class="body" rowspan="3"><img id="tztpSrc" src="" height="50px" width="130px">					
				</td>
			</tr>
			<tr>
