...
<div id="panel" style="display:none">
	...
	<c:forEach items="${funcList}" var="current">
		<c:if test='${current.gnid == "l121"}'>
			<div id="tag_body_l121" class="tag_body">
				<form name="myforml121" id="myforml121" action="<c:url value='passQuery.tfc?method=fuzzyQueryLocal'/>" method="post">
					<table border="0" cellspacing="1" cellpadding="0" class="query" width="100%">
						...
						<tr>
							...
							<td class="body">
								<select id="glbm" name="glbm" style="width:100%" onchange="getTollgateAndRoad()">
									<option value=""></option>
									<c:forEach var="current" items="${gateDeptList}">
										<option value="<c:out value='${current.glbm}'/>"><c:out value='${current.bmmc}'/></option>
									</c:forEach>
								</select>
							</td>
							<td class="head">卡口类型</td>
							<td class="body"><h:codebox list='${kklxList}' id='kklx' haveNull='1' onChange="getTollgateAndRoad()"/></td>
							<td class="head">道路类型</td>
							<td class="body"><h:codebox list='${ldlxList}' id='ldlx' haveNull='1' onChange="getTollgateAndRoad()"/></td>
						</tr>
						<tr>
							...
							<td class="body" colspan="3" valign="middle">
								...
								<input type="button" value="全部选择" onclick="selectAllGate(true)">
								<div id="kkbhDIV" style="width:100%;overflow:auto;height:100px;border:1px solid #F0F0F0;"></div>
							</td>
						...
						<tr>
							...
							<td class="body" colspan="3">
								<h:datebox id="kssjl121" name="kssj" showType="2" />
								至
								<h:datebox id="jssjl121" name="jssj" showType="2" />
							</td>
							<td class="head"><span class="gotta">*</span>查询原因</td>
							<td class="body">
								<h:codebox id="purposel121" name="purpose" list="${cxyyList}" haveNull="1"/>
							</td>
						</tr>
						<tr>
							<td class="head">结果展现方式</td>
							<td class="body" colspan="5">
								<input type="radio" id="showStylel121" name="showStyle" value="1" checked onclick="doShowStyleChange()">列表&nbsp;
								<input type="radio" id="showStylel121" name="showStyle" value="2" onclick="doShowStyleChange()">缩略图&nbsp;
								<div id="dddmm"></div>
							</td>
							<%--<td class="head"><span class="gotta">*</span>验证码</td>
		              		<td  class="body" nowrap><input name="yzm" id="yzm" type="text"  maxlength="4"  style="width:75;text-transform: uppercase;"  value="" >
		              			<iframe id="yzm_1" name="ifrmaeecsideveh" width="150" height="30" frameborder="0" src="tfcQuery.tfc?method=getValidImageOpen" allowTransparency="false" scrolling=no></iframe>
		             	 	</td> --%>
						</tr>
						
						<tr>
							<td class="submit" colspan="6">
								<input type="button" class="button_query" value="查询" onclick="query_cmd('l121')">
		...
		<c:if test='${current.gnid == "l122"}'>
			<div id="tag_body_l122" class="tag_body">
				<form name="myforml122" id="myforml122" action="<c:url value='passQuery.tfc?method=fuzzyQueryProvince'/>" method="post">
					<table border="0" cellspacing="1" cellpadding="0" class="query" width="100%">
						<col width="10%">
						<col width="23%">
						<col width="10%">
						...
						<tr>
							<td class="head"><span class="gotta">*</span>过车时间</td>
							<td class="body" colspan="3">
								<h:datebox id="kssjl122" name="kssj" showType="2" />
								至
								<h:datebox id="jssjl122" name="jssj" showType="2" />
							</td>
							<td class="head"><span class="gotta">*</span>查询原因</td>
							<td class="body">
								<h:codebox id="purposel122" name="purpose" list="${cxyyList}" haveNull="1"/>
							</td>
						</tr>
						<tr>
							<td class="submit" colspan="6">
								<input type="radio" id="showStylel122" name="showStyle" value="1" checked style="display:none;">
								<div id="dddmm"></div>
								<input type="button" class="button_query" value="查询" onclick="query_cmd('l122')">
								<input type="button" class="button_save" value="反馈" onclick="handled_cmd()">
								<input type="button" class="button_close" value="关闭" onclick="javascript:window.close()"> 
							</td>
						</tr>
		...
		<c:if test='${current.gnid == "l123"}'>
			<div id="tag_body_l123" class="tag_body">
				<form name="myforml123" id="myforml123" action="<c:url value='passQuery.tfc?method=fuzzyQueryProvinceRoaming'/>" method="post">
					<table border="0" cellspacing="1" cellpadding="0" class="query" width="100%">
						<col width="10%">
						<col width="23%">
						<col width="10%">
