...
//		getTollgate();
	...
	function localReturns(data) {
		...
		if (queryModel == 'l126' || queryModel == 'l127') {
	...
	function showDetail(gcxh, pageNum, listNum) {
		detailUrl = "<c:url value='tshpQuery.tfc?method=showNoPlateDetail&gcxh='/>"
	...
	function gotoPage(idx) {
		...
		setQueryingHtml();
		curUrl = "<c:url value='tshpQuery.tfc?method=queryNoPlate&goto=true&page='/>"
...
<body height="1024">
	<div id="tag_body" class="tag_body">
		<form name="myform" id="myform"
			action="<c:url value='tshpQuery.tfc?method=queryNoPlate'/>"
			method="post">
			<table border="0" cellspacing="1" cellpadding="0" class="query"
				...
				<tr>
					...
					<td class="submit" colspan="4"><input type="button"
