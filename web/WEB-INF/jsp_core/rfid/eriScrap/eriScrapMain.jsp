...
<html>
	...
	<body>
		<div id="panel" style="display: none">
			...
			<div class="queryresult" style="margin-top:20px;"></div>
					...
					<table border="0" cellspacing="1" cellpadding="0" class="list">
						...
						<c:forEach items="${queryList}" var="current">
							<tr class="out" onMouseOver="this.className='over'"
								...
								onDblClick="scrapedit('<c:out value='${current.bfdh}'/>')">
								<td>
...
function query_cmd(){
	$("#myform").attr("action","<c:url value='/eri-scrap.frm?method=query-scrap'/>");
	closes();
	$("#myform").submit();
}
function scrapedit(bfdh) {
	openwin("/rmweb/eri-scrap.frm?method=edit-Scrap&bfdh="+bfdh, "editScrap");
}
</script>
</html>