...
function ttb_title(title){
	...
	function atm_title(title){
		var s="";
		s+='<table width="100%" border="0" cellspacing="0" cellpadding="0">';
		s+='<tr><td height="144" colspan="7">&nbsp;</td></tr><tr><td width="46" rowspan="4">&nbsp;</td>';
		s+='<td><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>';
		s+='<td width="4" background="'+u+'/theme/style/main_r3_c2.jpg" height="67"></td>';
		s+='<td width="265" background="'+u+'/theme/style/main_r3_c3.jpg" height="67">&nbsp;</td>';		
		s+='<td width="" height="67" background="'+u+'/theme/style/main_r3_c5.jpg" class="text_black text_bold" style="font-size:36" align="center">&nbsp;'+title+'&nbsp;</td>';		
		s+='<td width="215" background="'+u+'/theme/style/main_r3_c6.jpg" height="67">&nbsp;</td>';				   
		s+='<td width="19" background="'+u+'/theme/style/main_r3_c7.jpg" height="67"></td></tr></table>';		
		s+='<td width="34" rowspan="4">&nbsp;</td></tr><tr>';
		s+='<td><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>';
		s+='<td width="4" height="400" background="'+u+'/theme/style/main_r4_c2.jpg" ></td>';
		s+='<td class="text_12" valign="top" bgcolor="e0ebf7">';
		document.write(s);
		}

	function atm_down(){
		var s="";
		s+='</td><td width="7" height="400" background="'+u+'/theme/style/main_r4_c8.jpg"></td>';
		s+='</tr></table></td></tr><tr><td>';
		s+='<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>';
		s+='<td width="18" background="'+u+'/theme/style/main_r5_c2.jpg" height="17"></td>';
		s+='<td width="" background="'+u+'/theme/style/main_r5_c4.jpg" height="17"><img src="'+u+'/theme/style/spacer.gif" width="1" height="1" /></td>';
		s+='<td width="19" background="'+u+'/theme/style/main_r5_c7.jpg" height="17"></td>';
		s+='</tr></table>';
		s+='</td></tr><tr><td height="78" colspan="3">&nbsp;</td></tr></table>';
		document.write(s);
		}	
...
/*
	function atm_title(title){
		var s="";
		s+='<table width="100%" border="0" cellspacing="0" cellpadding="0">';
		s+='<tr><td height="111" colspan="5">&nbsp;</td></tr><tr><td width="43" rowspan="4">&nbsp;</td>';
		s+='<td width="266" background="'+u+'/theme/style/main_r2_c2.jpg" height="67">&nbsp;</td>';
		s+='<td width="442" height="67" background="'+u+'/theme/style/main_r2_c4.jpg" class="text_black text_bold" style="font-size:36" align="center">&nbsp;'+title+'&nbsp;';
        s+='<td width="239" background="'+u+'/theme/style/main_r2_c5.jpg">&nbsp;</td>';
		//s+='<td width="239"><img src="'+u+'/theme/style/main_r2_c5.jpg" width="239" height="67" border="0"></td>';
		s+='<td width="34" rowspan="4">&nbsp;</td></tr><tr>';
		s+='<td colspan="3">111<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>';
		s+='<td width="10" height="400" background="'+u+'/theme/style/main_r3_c2.jpg" ></td>';
		s+='<td class="text_12" height="100" valign="top" background="'+u+'/theme/style/main_r3_c3.jpg" >';
		document.write(s);
		}

	function atm_down(){
		var s="";
		s+='</td><td width="13" height="400" background="'+u+'/theme/style/main_r3_c7.jpg"></td>';
		s+='</tr></table></td></tr><tr>';
		s+='<td colspan="3" width="947" height="25" background="'+u+'/theme/style/main_r4_c2.jpg">&nbsp;</td>';
		s+='</tr><tr><td height="78" colspan="3">&nbsp;</td></tr></table>';
		document.write(s);
		}
...
*/
	...
	function title_down(){
		var s="";
		s+='<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="text_14 text_bold"><tr>';
		s+='<td valign="middle" height="30" align="center">&nbsp;&nbsp;版权所有&copy;2011&nbsp;&nbsp;公安部交通管理科学研究所&nbsp;&nbsp;&nbsp;&nbsp;技术支持：公安部交通管理科学研究所二部&nbsp;&nbsp;&nbsp;&nbsp;支持电话：0510-85520722</td>';
		s+='</tr></table>';
		document.write(s);
		}