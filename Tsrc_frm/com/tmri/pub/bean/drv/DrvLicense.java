...
public class DrvLicense implements Serializable {
	private String xh = "";
	private String dabh = "";
	private String sfzmmc = "";
	private String sfzmmc_mc = "";// 带后缀_mc为代码翻译
	...
	private String djzsxzqh_mc = "";
	private String djzsxxdz = "";
	private String lxzsxzqh = "";
	private String lxzsxzqh_mc = "";
	...
	private String glbm = "";
	private String fzjg = "";
	private String dwbh = ""; // 社区属性
	private String lastqfrq = "";
	private String lastMfqfrq = ""; // 驾驶人最后一次满分清分日期 xuxd
	...
	private String xzcrq;
	
	private String zjcxmc;			//准驾车型名称
	private String sxbjmc;			//实习标记名称

	public String getRyztmc() {
		return ryztmc;
	}

	public void setRyztmc(String ryztmc) {
		this.ryztmc = ryztmc;
	}
	...
	public String getSxbj() {
		return StringUtil.transBlank(sxbj);
	}
	...
	public String getSyyxqz() {
		if(StringUtil.checkBN(syyxqz)) {
			return syyxqz.substring(0,10);
		}
		return StringUtil.transBlank(syyxqz);
	}
	...
	public String getXczg() {
		return StringUtil.transBlank(xczg);
	}
	...
	public String getLastMfqfrq() {
		return lastMfqfrq;
	}

	public void setLastMfqfrq(String lastMfqfrq) {
		this.lastMfqfrq = lastMfqfrq;
	}

	public String getLastqfrq() {
		return lastqfrq;
	}

	public void setLastqfrq(String lastqfrq) {
		this.lastqfrq = lastqfrq;
	}
	...
	public String getSfzmmc_mc() {
		return sfzmmc_mc;
	}

	public void setSfzmmc_mc(String sfzmmc_mc) {
		this.sfzmmc_mc = sfzmmc_mc;
	}
	...
	public String getDjzsxzqh_mc() {
		return djzsxzqh_mc;
	}

	public void setDjzsxzqh_mc(String djzsxzqh_mc) {
		this.djzsxzqh_mc = djzsxzqh_mc;
	}
	...
	public String getLxzsxzqh_mc() {
		return lxzsxzqh_mc;
	}

	public void setLxzsxzqh_mc(String lxzsxzqh_mc) {
		this.lxzsxzqh_mc = lxzsxzqh_mc;
	}
	...
	public String getCclzrq() {
		if(StringUtil.checkBN(cclzrq)) {
			return cclzrq.substring(0,10);
		}
		return cclzrq;
	}
	...
	public String getJzqx_mc() {
		return jzqx_mc;
	}

	public void setJzqx_mc(String jzqx_mc) {
		this.jzqx_mc = jzqx_mc;
	}
	...
	public String getYxqz() {
		if(StringUtil.checkBN(yxqz)) {
			return yxqz.substring(0,10);
		}
		return yxqz;
	}
	...
	public String getCfrq() {
		if(StringUtil.checkBN(cfrq) && !"|null|".equals(cfrq) && cfrq.length() >= 10) {
			return cfrq.substring(0,10);
		}
		return cfrq;
	}
	...
	public String getLy_mc() {
		return ly_mc;
	}

	public void setLy_mc(String ly_mc) {
		this.ly_mc = ly_mc;
	}
	...
	public String getFzjg_mc() {
		return fzjg_mc;
	}

	public void setFzjg_mc(String fzjg_mc) {
		this.fzjg_mc = fzjg_mc;
	}

	public String getYcsrq() {
		return ycsrq;
	}

	public void setYcsrq(String ycsrq) {
		this.ycsrq = ycsrq;
	}
	...
	public String getXiangzhen_mc() {
		return xiangzhen_mc;
	}

	public void setXiangzhen_mc(String xiangzhen_mc) {
		this.xiangzhen_mc = xiangzhen_mc;
	}

	public String getCun_mc() {
		return cun_mc;
	}

	public void setCun_mc(String cun_mc) {
		this.cun_mc = cun_mc;
	}
	...
	public String getSxbjmc() {
		return sxbjmc;
	}

	public void setSxbjmc(String sxbjmc) {
		this.sxbjmc = sxbjmc;
	}
	...
	private String sqdm = "";
	private String zxbh = "";
	private String fzjg_mc = "";
	private String ycsrq = "";
	private String xiangzhen = "";
	private String cun = "";
	private String xiangzhen_mc = "";
	private String cun_mc = "";
}
