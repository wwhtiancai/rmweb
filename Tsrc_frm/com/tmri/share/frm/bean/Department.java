...
public class Department implements Serializable {
	...
	private String jzjbmc;
	private String gltzmc;
	private String jflymc;
	private String yflymc;
	private String jrgawmc;
	private String lsgxmc;
	...
	public String getJzjbmc() {
		return jzjbmc;
	}

	public void setJzjbmc(String jzjbmc) {
		this.jzjbmc = jzjbmc;
	}
	...
	public void setGltzmc(String gltzmc) {
		this.gltzmc = gltzmc;
	}
	...
	public String getYflymc() {
		return yflymc;
	}

	public void setYflymc(String yflymc) {
		this.yflymc = yflymc;
	}

	public String getJrgawmc() {
		return jrgawmc;
	}

	public void setJrgawmc(String jrgawmc) {
		this.jrgawmc = jrgawmc;
	}
