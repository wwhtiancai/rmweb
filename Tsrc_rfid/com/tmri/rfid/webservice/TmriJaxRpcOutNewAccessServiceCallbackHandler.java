...
public abstract class TmriJaxRpcOutNewAccessServiceCallbackHandler {
    ...
    public void receiveResultwriteObjectOut(
        com.tmri.rfid.webservice.TmriJaxRpcOutNewAccessServiceStub.WriteObjectOutResponse result) {
    }
     ...
     */
    public void receiveErrorwriteObjectOut(Exception e) {
    }
    ...
    public void receiveResultqueryObjectOut(
        com.tmri.rfid.webservice.TmriJaxRpcOutNewAccessServiceStub.QueryObjectOutResponse result) {
    }
     ...
     */
    public void receiveErrorqueryObjectOut(Exception e) {
    }
}
